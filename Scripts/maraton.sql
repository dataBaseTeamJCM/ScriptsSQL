    ...
    CREATE TABLE MTN.VIAJA(                                        /*MODIFICAR DATA*/
        ID_EQUIPO       MTN.DIEZ_CARACTERES     NOT NULL,          /*cambio por ID-Equipo*/
        ID_ACTIVIDAD    MTN.DIEZ_CARACTERES     NOT NULL,
        DIAS            MTN.CANT_DIAS           NOT NULL,
        FINANCISTA      MTN.TREINTA_CARACTERES  NOT NULL,          /*AGREGAR*/
        HOSPEDAJE       MTN.TREINTA_CARACTERES  NOT NULL,          /*AGREGAR*/
    ...
    CREATE TABLE MTN.PREPARA_A(                                 /*MODIFICAR DATA*/
        CI_PROFESOR     MTN.DIEZ_CARACTERES     NOT NULL,
        CI_ESTUDIANTE   MTN.DIEZ_CARACTERES     NOT NULL,
        CLASES          MTN.TREINTA_CARACTERES  NOT NULL,       /*AGREGAR*/
    ...
    CREATE TABLE MTN.TIPO_INCIDENTE(
        ...
        ID_EQUIPO       MTN.DIEZ_CARACTERES     NOT NULL,   /*NUEVO*/
        ID_ACTIVIDAD    MTN.DIEZ_CARACTERES     NOT NULL,
